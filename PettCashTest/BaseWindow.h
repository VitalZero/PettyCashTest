...
// class declarations
template <class DERIVED_T>
HRESULT BaseWindow<DERIVED_T>::Create(
	LPCWSTR wndName,
	DWORD style,
	DWORD exStyle,
	int x,
...
template <class DERIVED_T>
ATOM BaseWindow<DERIVED_T>::Register()
{
	WNDCLASSEX wcx = {};
...
template <class DERIVED_T>
LRESULT CALLBACK BaseWindow<DERIVED_T>::WndProc(HWND procWnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
